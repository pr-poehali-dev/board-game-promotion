        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fade-in">
              ...
              <h1 className="md:text-7xl leading-tight text-center drop-shadow-[0_4px_8px_rgba(0,0,0,0.3)] [text-shadow:0_0_30px_rgba(52,211,153,0.5),0_0_60px_rgba(52,211,153,0.3)] text-blue-600 text-4xl font-black my-[70px] py-3.5 px-1 mx-0">The game of 
«knowledge or action»
